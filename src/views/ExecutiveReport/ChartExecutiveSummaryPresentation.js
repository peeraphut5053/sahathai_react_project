...
const ChartExecutiveSummaryPresentation = (props, { className, ...rest }) => {
...
ChartExecutiveSummaryPresentation.propTypes = {
  className: PropTypes.string
};

export default ChartExecutiveSummaryPresentation;
