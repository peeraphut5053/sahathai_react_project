    ...
    const { data: test, isLoading, error } = useQuery({
        ...
        queryFn: async () => {
            try {
                ...
                const wcList = [["P2FM01", "สถานี Forming 01"], ["P2FM05", "สถานี Forming 05"], ["P2FM06", "สถานี Forming 06"], ["P2FM08", "สถานี Forming 08"], ["P2FM09", "สถานี Forming 09"],["P2FM10", "สถานี Forming 10"], ["W2FM02", "สถานี Forming 02"], ["W2FM04", "สถานี Forming 04"], ["W2FM07", "สถานี Forming 07"],["W2FM11", "สถานี Forming 11 วังน้อย"], ["W2FMC1", "สถานีตัวซีเครื่อง 1"],["P1SL03", "สถานี Slit 03"], ["P1SL05", "สถานี Slit 05"], ["W1SL04", "สถานี Slit 04 วังน้อย"], ["P5HTF5", "สถานีเทสน้ำ F5"], ["P5HF10", "สถานีเทสน้ำ F10 "], ["P5HTO1", " สถานีเทสน้ำ O1 A6"], ["P5HTO2", "สถานีเทสน้ำ O2 A6"], ["W5HT02", "สถานีเทสน้ำ 02 วังน้อย"], ["W5HT04", "สถานีเทสน้ำ 04 วังน้อย"], ["W5HT06", "สถานีเทสน้ำ 06 วังน้อย"],["P6GL01", "สถานีชุป 01"], ["P6GL02", "สถานีชุป 02"], ["P6PT01", "สถานีพ่นสี 01"], ["P6PT0A", "สถานีพ่นสี A"], ["P6PT0B", "สถานีพ่นสี B"], ["P6PT0C", "สถานีพ่นสี C"],["P6TH01", "สถานนีต๊าป 01"], ["P6TH02", "สถานนีต๊าป 02"], ["P6TH03", "สถานนีต๊าป 03"], ["P6TH05", "สถานนีต๊าป 05"],["P6RG01", "สถานี Groove 1"], ["P6RG02", "สถานี Groove 2"], ["W6RG02", "สถานี Groove 2 วังน้อย"],["P6CT01", "สถานีตัดแบ่งความยาว No.1"], ["P6CT02", "สถานีตัดแบ่งความยาว No.2"], ["P6CT03", "สถานีตัดแบ่งความยาว No.3 เลเซอร์"], ["P6CT04", "สถานีตัดแบ่งความยาว No.4"], ["P6CT05", "สถานีตัดแบ่งความยาว No.5"], ["W6CT01", "สถานีตัดท่อ"],["P7PK00", "สถานีแพ๊ค"], ["P7PKP1", "สถานีแพ๊ค ท้ายเครื่องพ่นสี 1"], ["P7PKPA", "สถานีแพ๊ค ท้ายเครื่องพ่นสี A"], ["P7PKPB", "สถานีแพ๊คท้ายเครื่องพ่นสี PB"], ["P7PKPC", "สถานีแพ๊คท้ายเครื่องพ่นสี PC"], ["W7PK01", "สถานีแพ็ควังน้อย"]];
                ...
                const res = wcList.map(([wc, description]) => {
                    ...
                    if (foundItem) {
                        return {
                            ...foundItem,
                            DayTon: foundItem.DayTon != null && !isNaN(foundItem.DayTon) && Number(foundItem.DayTon) > 0 ? Number(foundItem.DayTon).toFixed(2) : 0,
                            DayTonHrs: foundItem.DayTonHrs != null && !isNaN(foundItem.DayTonHrs) && Number(foundItem.DayTonHrs) > 0 ? Number(foundItem.DayTonHrs).toFixed(2) : 0,
                            DayPcs: foundItem.DayPcs != null && !isNaN(foundItem.DayPcs) && Number(foundItem.DayPcs) > 0 ? Number(foundItem.DayPcs).toLocaleString() : 0,
                            DayPcsHrs: foundItem.DayPcsHrs != null && !isNaN(foundItem.DayPcsHrs) && Number(foundItem.DayPcsHrs) > 0 ? Number(foundItem.DayPcsHrs).toLocaleString() : 0,
                            OTton: foundItem.OTton != null && !isNaN(foundItem.OTton) && Number(foundItem.OTton) > 0 ? Number(foundItem.OTton).toFixed(2) : 0,
                            OTtonHrs: foundItem.OTtonHrs != null && !isNaN(foundItem.OTtonHrs) && Number(foundItem.OTtonHrs) > 0 ? Number(foundItem.OTtonHrs).toFixed(2) : 0,
                            OTpcs: foundItem.OTpcs != null && !isNaN(foundItem.OTpcs) && Number(foundItem.OTpcs) > 0 ? Number(foundItem.OTpcs).toLocaleString() : 0,
                            OTpcsHrs: foundItem.OTpcsHrs != null && !isNaN(foundItem.OTpcsHrs) && Number(foundItem.OTpcsHrs) > 0 ? Number(foundItem.OTpcsHrs).toLocaleString() : 0,
                        };
                    } else {
                        return {
                            wc,
