...
import { Box, Button, Container, Divider, Grid, Paper, TextField, Typography, CircularProgress } from '@mui/material';
  ...
  useEffect(() => {
    if (data.length > 0) {
      ...
      setSelectedRows((prevSelectedRows) => {
        if (prevSelectedRows.includes(latestRow)) {
  ...
  return (
    <Container maxWidth={false}>
      ...
      <DataTable
        ...
        sorting={false}
        exportButton
        exportFileName="job-material-tags.csv"
        selection
