...
function ExcelReportByPo(data, loc, boatPosition) {
   // 1. กำหนด header ภาษาไทย
   const headers = ['STS_PO', 'City', 'Uf_NPS', 'Uf_spec', 'Uf_Grade', 'Uf_Schedule', 'Uf_length', 'Uf_TypeEnd', 'PCS/BDL', 'Countlot', 'Weight', 'doc_num', 'tag_id'];
   ...
   XLSX.writeFile(workbook, `รายงานการเคลื่อนย้ายเรือ_${data[0].STS_PO}.xlsx`);
}

export { ExcelReportByPo };