...
//         API.get(`API_QuantityMove/data.php?load=STS_QtyMoveLotLocation_GEN_Doc_num`)
//         .then(res => {
//             setSTS_QtyMoveLotLocation_GEN_Doc_num(res.data)
//         })
...
//         } else {
//             if(STS_QtyMoveLotLocation_GEN_Doc_num.doc_num !== 'undefined' && STS_QtyMoveLotLocation_GEN_Doc_num.doc_num !== null && STS_QtyMoveLotLocation_GEN_Doc_num.doc_num !== ''){

//             API.get(`API_QuantityMove/data.php?load=moveqty_create_hdr&toLoc=${values.loc}&w_c=${values.wc}&doc_type=${values.doc_type}&do_num=${values.do_num}&boatList=${values.boatList}&destination=${destination}&ActWeight=${values.ActualWeight}&newdo_num=${STS_QtyMoveLotLocation_GEN_Doc_num.doc_num}`)
//                 .then(res => {
...
//                         //Insert QTY LINE 
//                         const timer = setInterval(() => {
//                             API.get(`API_QuantityMove/data.php?load=moveqty_create_line&docnum=${STS_QtyMoveLotLocation_GEN_Doc_num.doc_num}&docline=${i}&tagnum=${qtyMoveList[i - 1].id}&toLoc=${values.loc}&boatPosition=${qtyMoveList[i - 1].boat_position}`)
//                                 .then(res => {
