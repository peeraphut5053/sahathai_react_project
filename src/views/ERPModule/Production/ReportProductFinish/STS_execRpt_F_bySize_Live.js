...
import STS_execRpt_F_bySize_Live_Detail from './STS_execRpt_F_bySize_Live_Detail';
...
const STS_execRpt_F_bySize_Live = (props) => {
  ...
  const searchSTS_execRpt_F_bySize_Live = (daystart, dayend) => {
    ...
    API.get(`API_ExecutiveReport/data.php?load=STS_execRpt_F_bySize_Live&daystart=${daystart}&dayend=${dayend}`)
      .then(res => {
        setDataSTS_execRpt_F_bySize_Live(addTotal(res.data))
  ...
  return (
    ...
    >
      <ModalNopaperSmall
        ...
        modalDetail={
          <STS_execRpt_F_bySize_Live_Detail
